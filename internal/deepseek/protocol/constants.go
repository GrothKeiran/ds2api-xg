...
func normalizeClientConstants(in clientConstants) clientConstants {
	...
	if in.Platform == "android" && in.AndroidAPILevel == "" {
...
func buildBaseHeaders(client clientConstants, overrides map[string]string) map[string]string {
	...
	if client.Platform == "web" {
		out["User-Agent"] = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36"
